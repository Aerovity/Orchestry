...
class CollaborativeStoryEnvironment:
    ...
    def reset(self) -> State:
        ...
        self.current_episode = Episode(
            ...
            metadata={"theme": theme, "task": task_description, "num_agents": len(self.agents)},
        )
    ...
    def step(self, agent_idx: int) -> tuple[State, bool]:
        ...
        # Create message
        message = Message(role="assistant", content=response, turn=turn, agent_role=agent.role)
        ...
        self.current_episode.conversation.append(
            {"turn": turn, "agent": agent.role, "content": response},
        )
    ...
    def run_episode(self) -> Episode:
        ...
        while not done:
            _state, done = self.step(agent_idx)
