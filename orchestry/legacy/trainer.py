...
class Trainer:
    ...
    def train(
        ...
        for i in range(1, num_episodes + 1):
            # Run episode
            self.run_episode(i, verbose=verbose)
    ...
    def _save_final_results(self) -> None:
        ...
        with open(rewards_path, "w") as f:
            ...
            f.writelines(
                f"{i},{total},{quality},{collab},{eff},{length}\n"
                for i, (total, quality, collab, eff, length) in enumerate(
                    zip(
    ...
    def get_best_episode(self) -> Episode | None:
