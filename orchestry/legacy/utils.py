...
def plot_training_curves(metrics: dict[str, Any], save_dir: Path, show: bool = False) -> None:
    ...
    ax1.axhline(y=np.mean(metrics["episode_rewards"]), color="r", linestyle="--", label="Mean")
...
def plot_collaboration_analysis(metrics: dict[str, Any], save_dir: Path) -> None:
