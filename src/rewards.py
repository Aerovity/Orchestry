...
Format your response as: SCORE: X.X"""
        ...
        try:
            ...
            logger.error(f"Error evaluating story quality: {e}")
...
Format your response as: SCORE: X.X"""
        ...
        try:
            ...
            patterns = self._extract_collaboration_patterns(episode)
    ...
    def _extract_collaboration_patterns(self, episode: Episode) -> List[str]:
        ...
        for i, turn in enumerate(conversation[1:], 1):
            ...
            if any(word in content_lower for word in ["building on", "expanding", "continuing", "yes,"]):
