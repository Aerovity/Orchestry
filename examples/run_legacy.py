...
def display_episode_progress(
    ...
    Args:
        _episode_num: Current episode number (unused)
        _total_episodes: Total episodes (unused)
    ...
    for turn_data in conversation:
        ...
        color_map = {"Creative Writer": "green", "Editor": "yellow", "Narrator": "blue"}
...
def display_training_summary(metrics: dict[str, Any], save_dir: Path) -> None:
...
def main() -> None:
    ...
    parser.add_argument("--episodes", type=int, help="Number of episodes to run (overrides config)")

    parser.add_argument("--test", action="store_true", help="Run in test mode (3 quick episodes)")

    parser.add_argument("--verbose", action="store_true", help="Show detailed episode output")

    parser.add_argument("--show-best", action="store_true", help="Display best episode at the end")
